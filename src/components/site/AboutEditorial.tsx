...
export function AboutEditorial() {
  return <Shell><div className="about-editorial">
    ...
    <section className="buyer-faq" id="faq" data-tone="paper" aria-labelledby="faq-title"><div className="editorial-width faq-grid">
      ...
      <div className="faq-list">{buyerFaqs.map(([question, answer]) => <details key={question}><summary>{question}</summary><div className="faq-answer"><p>{answer}</p></div></details>)}</div>
    </div></section>
