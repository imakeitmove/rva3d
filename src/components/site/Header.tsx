...
const links = [["/work", "Work"], ["/capabilities", "Capabilities"], ["/about", "About"], ["/#contact", "Contact"], ["/login", "Client login"]];
export function Header() {
  return <><a className="skip-link" href="#main">Skip to content</a><header className="site-header"><div className="frame header-inner">
    <a className="brand" href={siteHref()} aria-label="RVA3D home"><Brand /></a>
