...
export function Contact({ testMode = false }: { testMode?: boolean }) {
  ...
  </div>{/* Previous UI launch gate: process.env.RVA3D_PUBLIC_LAUNCH_ENABLED === "1". */}<InquiryForm testMode={testMode} sendingEnabled={publicInquiryDeliveryEnabled()} /></div><footer className="v-frame v-footer"><div><Brand /><span>Richmond, VA</span></div><nav className="v-footer-links" aria-label="Studio information"><a href={siteHref("/about#how-we-work")}>How we work</a><a href={siteHref("/about#faq")}>FAQ</a><a href={siteHref("/about#collaborate")}>Collaborate with <Brand /></a></nav><small>© 2026 Make It Move, LLC. All rights reserved.</small></footer></section>;
}
